...
export const hollowStarZone: Zone = defineZone({
  ...
  rooms: [
    ...
    { id: "scriptorium",    x: 0, y: 3, w: 1, h: 1, title: "Records Bay",            description: "Shelves of outdated storage cores lean against walls slick with coolant seepage. Half the ceiling panels have buckled.",                                                    ceilingColor: "#19141f", discoveryText: "Something shifts behind the fallen rack.",        encounterId: "scriptorium_rats" },
    ...
    { id: "echo_bridge",    x: 2, y: 2, w: 1, h: 1, title: "Cable Gantry",           description: "A narrow walkway crosses a vertical service shaft. The station's vent system carries fragmented audio up from decks below — voices, or interference, it is hard to say.", ceilingColor: "#10161f", discoveryText: "The gantry grating vibrates with low-frequency hum." },
    ...
    { id: "star_sanctum",   x: 3, y: 0, w: 2, h: 1, title: "Signal Core Chamber",    description: "A wide chamber houses a derelict antenna array, its dish angled toward a fixed point in the dark beyond the station hull. The relay equipment spans the full width of the room.",             surfaceOverrides: { wallTexture: WALL_MAINT_B }, ceilingColor: "#101a30", discoveryText: "The array indicators flicker green as you approach.", victory: true },
...
export const stationIndustrialZone: Zone = defineZone({
  ...
  rooms: [
    ...
    { id: "ind_machine_deck",      x: 1, y: 1, w: 1, h: 1, title: "Machine Deck",               description: "A wide deck lined with industrial machinery — press units, fabrication arms, heavy-load conveyors. Several units show signs of hasty disassembly, components stripped and missing.",                 ceilingColor: "#161014", discoveryText: "Something is wrong with one of the fabrication arms — it is moving when it should not be.", encounterId: "ind_bot_encounter" },
...
export const stationEastZone: Zone = defineZone({
  ...
  rooms: [
    ...
    { id: "breach_staging",  x: 2, y: 0, w: 1, h: 1, title: "Staging Corridor",         description: "A wide corridor used for staging heavy equipment before dock operations. Smoke from an electrical fault hangs near the ceiling. The lights at the far end have been shot out.",                               ceilingColor: "#1c1212", discoveryText: "The smell of burning insulation and something unfamiliar — the boarders' weapons." },
    { id: "east_entry",      x: 0, y: 1, w: 1, h: 1, title: "East Section Entry",        description: "The main access corridor into the eastern docking sections. Blast marks on the bulkheads. A body — station security — lies near the far wall. The attack is not over.",                                      ceilingColor: "#201414", discoveryText: "The attack reached here before you did." },
    ...
    { id: "east_storage_bay",   x: 2, y: 2, w: 1, h: 1, title: "Emergency Storage Bay",     description: "A sealed bay for emergency equipment. The alarm state unlocked it automatically. Whoever came through took the weapons — the medical supplies were left behind.",                                                                         ceilingColor: "#1c1212", discoveryText: "The bay was sealed until the alarm opened it. Medical supplies still here.", loot: ["medkit", "medkit"] }
  ],
  edges: [
    { x: 0, y: 0, dir: "h", type: "open" },
    { x: 1, y: 0, dir: "h", type: "open" },
...
export const props: PropDef[] = [
  {
    ...
    description: "A low thermal canister throws a wavering blue flame across the chamber.",
    iconLabel: "OBJ"
  }
];
